...
public class SamplePreparator {
  ...
  public boolean processTSV(File file, IExperimentalDesignReader reader, boolean parseGraph)
    ...
    // qReader.getDescription(), qReader.getSecondaryName(),
  ...
  public List<PreliminaryOpenbisExperiment> getSpecialExperimentsOfType(
      ExperimentType experimentType) {
    if (reader.getExperimentInfos() == null)
      return new ArrayList<>();
    List<PreliminaryOpenbisExperiment> exps = reader.getExperimentInfos().get(experimentType);
    return exps;
  }
